      ...
      <div class="modal-dialog modal-md-2 modal-center" role="document">
        <div class="modal-content bg-white">
          <div class="modal-body p-4">
            ...
            <form method="post" action="<?php echo e(route('add-user')); ?>" id="adduser">
              <?php echo csrf_field(); ?>
		...
		<div class="modal-dialog modal-md-2 modal-center" role="document">
			<div class="modal-content bg-white">
				<div class="modal-body p-4">
					...
					<form action="<?php echo e(route('edit-user',['id'=> $item['id']])); ?>" method="post" id="editVolumeForm">
						<?php echo csrf_field(); ?>
						<div class="form-group mt-4">
							<label>User Name</label>
							<input type="text" maxlength="20" class="form-control bg-gray border-0 font-14 text-black" name="name" value="<?php echo e($item->name); ?>">
						</div>
						<div class="form-group">
							<label>Email</label>
							<input type="email" maxlength="100" class="form-control bg-gray border-0 font-14 text-black" name="email" value="<?php echo e($item->email); ?>">
						</div>
            <div class="form-group">
							<label>Address</label>
							<input type="text" maxlength="100" class="form-control bg-gray border-0 font-14 text-black" name="address" value="<?php echo e($item->address); ?>">
						</div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('Admin.layouts.master_after_login', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/Project/resources/views/Admin/usermanagement.blade.php ENDPATH**/ ?>